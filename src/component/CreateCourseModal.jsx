...
const CreateCourseModal = ({ isOpen, onClose, onSubmit, courseData, setCourseData }) => {
  const url = useAuthStore((state) => state.url);
  const [categories, setCategories] = useState([]); // ✅ fetch real categories
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleInputChange}
              required
              className="w-full h-32 px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 resize-none"
            />
          </div>
