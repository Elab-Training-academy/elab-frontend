...
const FlashcardPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      {/* Top Search Bar */}
      <div className="w-full bg-white shadow px-4 py-3 flex items-center rounded-xl">
      ...
      <div className="p-6 flex flex-col gap-8 items-center flex-grow">
        {/* Header */}
        <div className="text-left w-full">
          <p className="text-[28px] font-bold text-blue-600">Flash Cards</p>
          <p className="text-gray-500 text-[14px]">
            Exam prep, one card at a time
          </p>
        </div>
        ...
        {!loading && filteredFlashcards.length === 0 && (
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Try adjusting your search or select another category.
            </p>
          </div>
        )}
        ...
        {!loading && filteredFlashcards.length > 0 && (
          <div className="flex flex-col items-center gap-6 w-full max-w-xl">
            ...
            <div
              onClick={handleFlip}
              className="relative w-full h-60 sm:h-72 cursor-pointer group perspective"
            >
              <div
